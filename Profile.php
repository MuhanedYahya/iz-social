...
<div id="ProfileDiv">
             ...
             <div class="profilePicDiv" style="order:1;background-image: url(user_images/<?php echo $info["Profile_Picture"];?>)"></div>

             <div style="order:5;display: flex;flex-direction: row;justify-content:center;align-items: flex-start;margin:10px">

                <img src="images/students_30px.png" alt="student" >

               <a href="http://">
                <img src="images/microsoft_outlook_2019_30px.png" alt="outlook" >
               </a>
    ...
    <div class="info" style="order:2;word-wrap: break-word;max-width:130px">
           <h5 style="color:white;order:2">
            <?php
            echo $info["Name"];
            ?>
           </h5>
 ...
 <div class="textareaProfile" style="background-color:#8B2232;color:white;order:3">
  ...
  <div class="textareaProfile" style="order:4">
  <p>
     <?php
         echo $info["User_info"];
     ?>
 ...
 <div class="profileMenu">
    ...
    <span class="material-icons" style="font-size:30;cursor: pointer;color:white;" onclick="showMyQuestions()"  id="QButton">
                         quiz
    </span>

    <span class="material-icons" style="font-size:30;cursor: pointer;color:white;" onclick="showMyAnswers()"id="AButton">
                         question_answer
    </span>
...
<div id="Sorularim">
 ...
 ?>
  ...
  <div class="ProfilePage_Containers">

    <div style="order: 1;display:flex;flex-direction:row;align-items:center">
       
         <div class="smallPicDiv" style="order: 1;margin-right:10px;background-image: url(user_images/<?php echo $info["Profile_Picture"];?>)"></div>
        <div style="order: 2;display:flex;flex-direction:column;align-items:flex-start">
         <div>
         <a href="Profile.php?userID=<?php echo $_SESSION["userID"];?>&guestID=<?php echo $info["UserID"];?>" class="Black_Link">
            <?php
                echo $info["Name"];
            ?>
         </a>
    ...
    <a href="QuestionPreview.php?userID=<?php echo $_SESSION["userID"];?>&QuestionID=<?php echo  $AllQuestions["QuestionID"];?>" class="questionLink">
        ...
        <div class="ProfilePage_Containers_footer" style="order:3;">
             <a href="QuestionPreview.php?userID=<?php echo $_SESSION["userID"];?>&QuestionID=<?php echo  $AllQuestions["QuestionID"];?>" class="Black_Link">

            <div style="margin-right: 15px;margin-top:8px;text-align: center;">
                <span class="material-icons" alt="comment" style="font-size:30;margin-left: 5px;float: left;cursor: pointer;">
                       comment
                </span>
                ...
                <h6 style="margin-top: 2px;font-weight: normal;float: left;margin-left: 5px;">Answer</h6>
            </div>
            </a>   


            <span class="material-icons" alt="link" style="font-size:30;margin-right: 15px;cursor: pointer;">
                       link
            </span>
...
<div id="Cevaplarim">
 ...
 <?php
 $select_A=mysqli_query($connection,"SELECT DISTINCT *,AnswerID FROM `answers` WHERE UserID=$userid AND Parent_Answer_ID IS NULL ORDER BY AnswerID DESC");
 ...
 <div class="ProfilePage_Containers">
  ...
  <div style="margin:20px 20px 20px 20px;font-size: 17px;word-wrap: break-word;order: 2;font-weight: bold;">
        ...
        <div style="margin-left:15px">
             ...
             <?php
                    ...
                    <div style="margin-right: 15px">
                        ...
                        <span class="material-icons" alt="link" style="font-size:30;cursor: pointer;">
                          link
                       </span>
